...
bible <- subset(merged, grepl(":[[:digit:]]+", text))
...
clean <- read_csv("D://congress_tweets/bible_cong_clean.csv")
...
count$gender <- c("Male", "Male", "Male", "Male", "Male", "Male", "Male", "Male", "Female", "Male")
...
count %>% 
  ...
  geom_text(aes(y = n + 10, label = paste0(n)), position = position_dodge(width = .9), size = 6, family = "font") +
  labs(x = "Screen Name", y = "Number of Tweets", title = "Which Members Tweet Bible Verses?", caption = "Scraped from Twitter's API (2017 - 2018)", subtitle = "The Top 10 Accounts Were All Republicans") +
  ggsave(file="D://congress_tweets/images/fig6.png", dpi = 300, width = 10, height =6, type = "cairo-png")
